...
exports.uploadMiddleware = exports.deleteTeam = exports.updateTeam = exports.getTeam = exports.createTeam = void 0;
...
const deleteTeam = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.json({
            result: Object.assign({}, team),
            success: true,
        });
    }
    catch (error) {
        res.status(500).json({
            message: 'error happened at calling endpoint (/remove-team)',
            error: error,
            success: false,
        });
    }
